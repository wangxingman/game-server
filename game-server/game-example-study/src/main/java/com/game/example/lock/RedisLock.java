...
public class RedisLock {
     ...
     */
    public boolean lockOne(String key ,String value) {
     ...
     */
    public boolean lockTwo(String key ,String value) {
        //setIfAbsent相当于jedis中的setnx，如果能赋值就返回true，如果已经有值了，就返回false
        //即：在判断这个key是不是第一次进入这个方法
        if (redisTemplate.opsForValue().setIfAbsent(key, value)) {
    ...
    /**
     * @Author: wx
     * @Date  : 上午 11:26 2019/8/7 0007 
     * @params: 
     * @Desc  : 好点的加锁问题
     */
    public boolean lockThree(String key ,String value) {
        if (redisTemplate.opsForValue().setIfAbsent(key, value)) {
            return true;
        }
        String current_value = redisTemplate.opsForValue().get(key);
    ...
    public static void main(String[] args) {
        int a = 2;
        String format = String.format("%1$02d", a);
